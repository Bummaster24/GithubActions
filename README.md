[![Run App <Le>, <Jayden>](https://github.com/Bummaster24/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/Bummaster24/GithubActions/actions/workflows/ci.yml)
